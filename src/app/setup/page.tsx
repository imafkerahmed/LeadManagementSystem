    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 p-4">
      <div className="max-w-2xl mx-auto">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              ...
              <ul className="text-sm text-blue-800 space-y-2">
                <li>
                  <strong>users</strong> - User accounts (admins and counselors)
                </li>
                <li>
                  ...
                  <>
                    ...
                    <div>
                      ...
                      <p className="text-sm text-green-800 mt-1">
                        You can now start using the system. Go to the home page
                        to log in.
                      </p>
                    </div>
                  </>
        ...
        <div className="mt-8 bg-white rounded-lg shadow p-6">
          <h3 className="font-semibold text-gray-900 mb-3">📝 Setup Methods</h3>
          <div className="space-y-3 text-sm text-gray-700">
            <p>
              <strong>Method 1 (Recommended):</strong> Click the button above to
              set up collections automatically
            </p>
            <p>
